...
import { registerController , register42Controller , userGetterByUsername, userGetterByEmail, userGetterById, passwordControl, getCurrentUserController } from "../controllers/usersController";
